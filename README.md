...
Welcome to my GitHub! I'm currently immersed in the rigorous 12-week AWS re/Start program, a workforce development initiative that prepares individuals for entry-level cloud roles. Here I'm building a strong foundation in cloud architecture, automation, and operational excellence.
...
- **Designed a Three-Tier VPC Architecture**
  ...
  - Implemented public-facing load balancers, private application servers, and database layers
  - Configured security groups and network ACLs for defense-in-depth

- **Automated EC2 Backups with Lambda**
  - Wrote Python script (Boto3) triggered by CloudWatch Events
  - Creates snapshots of EBS volumes with specific tags
  - Demonstrates resource management and cost optimization

- **Implemented a Static Website on S3**
  - Hosted serverless website using S3 static web hosting
  - Integrated with CloudFront for low-latency content delivery
...
**Operating Systems:**
- Linux (Ubuntu, Amazon Linux 2) - Command Line Proficiency
...
**Networking:**
- TCP/IP, DNS, Subnetting, Firewalls (Security Groups/NACLs)
